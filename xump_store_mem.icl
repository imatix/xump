...
<method name = "online final">
    ...
    xump_store_response_online (self->portal, self->queue);
    </action>
</method>
...
static void s_terminate_peering (xump_store_amqp_t *self);
...
static void
s_terminate_peering (xump_store_amqp_t *self)
{
    ...
    if (self->connected) {
        ...
        self->offlined  = TRUE;
        if (self->portal)
            xump_store_response_offline (self->portal);
    }
}
...
static void s_synchronize_pipe (ipr_hash_t *hash, void *argument)
{
    ...
    xump_store_amqp_t
        *self = (xump_store_amqp_t *) argument;
    zyre_amqp_pipe_t
